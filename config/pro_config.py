...
# APP STATIC config
APP_STATIC_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "static")
APP_HTML_STATIC_DIR = "static/fe/build"
APP_LOG_PATH = os.path.join(APP_STATIC_DIR, 'logs', 'app.log')
...
#kaldi path
ENGLIST_KALDI_PATH = '/root/tools/kaldi/egs/librispeech/s5'
CHINESE_KALDI_PATH = '/root/tools/kaldi/egs/aidatatang_200zh/s5'
